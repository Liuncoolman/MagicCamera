...
public class FilterLayoutUtils{
	...
	private void loadFavourite(){
		...
		String[] typeList = ((Activity) mContext).getSharedPreferences("favourite_filter",Context.MODE_PRIVATE)
	...
	private void saveFavourite(){
		SharedPreferences shared = ((Activity) mContext).getSharedPreferences("favourite_filter",Context.MODE_PRIVATE);
